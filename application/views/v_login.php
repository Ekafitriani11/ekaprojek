...
<head>
  ...
  <meta name="generator" content="Eka">
...
<body class="text-center">
  <form class="form-signin" method="post" action="<?= base_url('auth/login_aksi'); ?>">
    <img class="mb-4" src="<?= base_url(); ?>assets/img/profile/bg.png" alt="" width="300px">
    ...
    <p class="mt-5 mb-3 text-muted">&copy; 2022 - Eka Klinik</p>
  </form>
</body>
